...
# For a detailed understanding of the CTC loss, refer to this post.
...
#In this section, we will implement it and use it as a callback to monitor our model.
...
# # Let's check results on some random test samples.
# for batch in test_ds.take(1):
#     batch_images = batch["image"]
#     batch_labels = batch["label"]

#     # Shuffle both images and labels together
#     shuffled_indices = tf.random.shuffle(tf.range(len(batch_images)))
#     shuffled_images = tf.gather(batch_images, shuffled_indices)
#     shuffled_labels = tf.gather(batch_labels, shuffled_indices)

#     # Select 16 random images from the shuffled batch
#     _, ax = plt.subplots(4, 4, figsize=(15, 8))

#     preds = prediction_model.predict(shuffled_images)
#     pred_texts = decode_batch_predictions(preds)
